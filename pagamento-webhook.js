 ...
 *
 * POR QUE ISTO VOLTOU. Eu tinha apagado este arquivo achando que o payment_check resolvia
 * melhor: a Carla perguntaria em vez de esperar, e o servidor não precisaria receber nada de
 * fora. Testamos com um pagamento de verdade e o payment_check devolveu {"success":false}
 * pra TODAS as combinações que a gente tem em mãos — só order_nsu, order_nsu com o código
 * hexadecimal do fim do lenc, o lenc inteiro como slug, e o hexadecimal como transaction_nsu.
 *
 * A leitura é que o payment_check foi feito pra confirmar quem VOLTOU pelo redirect, com o
 * transaction_nsu que só existe depois de a pessoa clicar em "Continuar". Não serve pra
 * descobrir quem pagou. Então perguntar está fora, e sobra o aviso.
 *
